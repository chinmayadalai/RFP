...
app.post('/channels', async function(req, res) {
	...
	logger.debug('channelConfigPath : ' + channelConfigPath); //../$FAB_NET_NM/channel/$CHANNEL.tx
	if (!channelName) {
...
app.post('/channels/:channelName/chaincodes', async function(req, res) {
	...
	var collectionsConfigPath = req.body.collectionsConfigPath;
	...
	let message = await instantiate.instantiateChaincode(peers, channelName, chaincodeName, chaincodeVersion, fcn, chaincodeType, args, req.username, req.orgname, collectionsConfigPath);
	res.send(message);
});
// Invoke transient transaction on chaincode on target peers
app.post('/channels/:channelName/chaincodes/:chaincodeName', async function(req, res) {
	...
	var fcn = req.body.fcn;
	var args = req.body.args;
	var transient_data = req.body.transient_data;
	var transient_data_obj = null
	...
	if(transient_data != null)
	{
		...
		transient_data_obj = { "printOrder":data}
		logger.debug('transient_data  : ' + JSON.stringify(transient_data_obj));
	}
	...
	if (!transient_data) {
		res.json(getErrorMessage('\'transient_data\''));
		return;
	}

	let message = await invoke.invokeChaincode(peers, channelName, chaincodeName, fcn, args, req.username, req.orgname, transient_data_obj);
	res.send(message);
});
